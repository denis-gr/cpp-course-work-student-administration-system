...
const auto GODBUY_MESSAGE = "До новых встречь...";
const auto INCORRECT_COMAND_MESSAGE = "До новых встречь...";
...
const auto PRINT_LIST_START_MESSAGE = "Студенты:\n";
const auto PRINT_LIST_EMPTY_MESSAGE = "Список студентов пуст...\n";
const auto PRINT_DELL_START_MESSAGE = "Студенты:\n0.\tВернуться в главное меню\n";
const auto PRINT_LIST_START2_MESSAGE = "Ваш ответ: ";
